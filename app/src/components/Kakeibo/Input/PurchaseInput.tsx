...
type PlainPurchaseInputProps = {
    ...
    addPurchase: () => void;
    addTemplate: () => void;
    setNewPurchase: React.Dispatch<
        React.SetStateAction<InputFieldPurchaseType>
    >;
            ...
            <Box display="flex">
                <FormGroup row sx={{ gap: 1, mr: 1, width: '100%' }}>
                    <TextField
                        ...
                        onChange={(e) =>
                            handleNewPurchaseInput('title', e.target.value)
                        }
                        error={!!errors.title}
                    ...
                    <TextField
                        ...
                        onChange={(e) =>
                            handleNewPurchaseInput('price', e.target.value)
                        }
                        error={!!errors.price}
